  ...
  return (
    <div className="flex flex-col gap-4 w-full">
      ...
      <div className="flex gap-3">
        {(["dni", "acta"] as DocumentType[]).map((t) => (
          <button
            key={t}
            type="button"
      ...
      <label
        ...
        className={`relative flex flex-col items-center justify-center gap-3 w-full rounded-2xl border-2 border-dashed p-10 cursor-pointer transition-colors
          ${dragging ? "border-zinc-900 bg-zinc-100 dark:border-white dark:bg-zinc-800" : "border-zinc-300 bg-zinc-50 hover:bg-zinc-100 dark:border-zinc-700 dark:bg-zinc-900 dark:hover:bg-zinc-800"}
      ...
      >
        <input
          ...
          disabled={disabled}
        />
        <svg className="w-10 h-10 text-zinc-400" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5" />
        </svg>
        <p className="text-sm text-zinc-500 dark:text-zinc-400 text-center">
          <span className="font-medium text-zinc-700 dark:text-zinc-200">Haz clic para seleccionar</span>
